<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 py-5">
        <div class="sm:px-20 mt-4">
            <div class="bg-white w-full rounded-2xl sm:px-10 sm:py-8 max-sm:py-4 max-sm:px-5 shadow-lg hover:shadow-2xl transition duration-500">
                <div class="text-left sm:flex sm:justify-between">
                    <img src="/storage/images/products/{{ $product->image }}"  class="rounded-md sm:w-1/2 sm:h-80 max-sm:w-52 max-sm:h-44 object-cover max-sm:mx-auto">
            ...
            <div>
                ...
                <ul class="sm:flex">
                    @foreach ($relations as $relation)
                        <li class="sm:w-1/3 rounded-2xl p-2 mb-3 hover:bg-gray-200 rounded-md transition duration-300 ease-out hover:ease-in">
