<x-app-layout>
    <h1 class="mt-7 mx-7 text-2xl font-semibold rounded-md max-sm:text-xl">ブランド名： {{ $brandName }}</h1>

    @if($showBrands->isEmpty())
        <p class="mt-7 mx-7 text-2xl font-semibold rounded-md max-sm:text-xl">このブランドには商品がありません。</p>
    @else
