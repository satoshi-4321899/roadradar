<x-app-layout>
    <h1 class="mt-7 mx-7 text-2xl font-semibold rounded-md max-sm:text-xl">カテゴリー: {{ $category }}</h1>

    @if($products->isEmpty())
        <p class="mt-7 mx-7 text-2xl font-semibold rounded-md max-sm:text-xl">このカテゴリーには商品がありません。</p>
    @else
