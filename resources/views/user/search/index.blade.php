<x-app-layout>
    <h1 class="mt-7 mx-7 text-2xl font-semibold rounded-md max-sm:text-lg">{{$minPrice}}円から{{$maxPrice}}円までの商品({{$category}})</h1>

    @if($searchProducts->isEmpty())
        <p class="mt-7 mx-7 text-2xl font-semibold rounded-md max-sm:text-lg">指定していただいた価格帯の商品がありません。</p>
    @else
