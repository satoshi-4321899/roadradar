<x-app-layout>
    <h1 class="mt-7 mx-7 text-2xl font-semibold rounded-md max-sm:text-lg">お気に入り商品一覧</h1>

    @if($favorites->isEmpty())
        <p class="mt-7 mx-7 text-2xl font-semibold rounded-md max-sm:text-lg">お気に入り登録された商品がありません。</p>
    @else
